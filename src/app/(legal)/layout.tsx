    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center p-4 md:p-8">
      <header className="w-full max-w-4xl mb-8">
        <div className="flex justify-between items-center py-4">
          <h1 className="text-3xl font-bold text-primary">Chatter Anon</h1>
      ...
      <footer className="w-full max-w-4xl mt-12 py-4 text-center text-xs text-muted-foreground border-t">
