...
export default function ChatApp() {
  ...
  const handleStartSearchRef = useRef(handleStartSearch); // Declare the ref
  ...
  useEffect(() => { handleStartSearchRef.current = handleStartSearch; }, [handleStartSearch]); // Update the ref
    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex flex-col">
        <header className="py-4 px-6 md:px-10 flex justify-between items-center border-b">
          ...
          {/* Active user count temporarily disabled due to quota issues
